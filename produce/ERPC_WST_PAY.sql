...
execute immediate 'comment on column ${tableName}.ERP_INS_ID is ''ERP端付款唯一标识:所有的付款业务类型统一标识''';
execute immediate 'comment on column ${tableName}.PAYER_ID is ''付款方ID:资金系统付款方单位编号''';
